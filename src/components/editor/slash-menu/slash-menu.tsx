            ...
            >
              ...
              <div class="flex-1 overflow-y-auto overscroll-contain p-1.5">
                ...
                {groupedItems.value.map((group, groupIndex) => (
                  <div
                    class={
                      groupIndex > 0
                        ? 'mt-2 border-t border-gray-100 pt-2 dark:border-gray-700'
                        : ''
                    }
                    key={group.id}
                  >
                    <div class="px-2 py-1.5 text-xs font-medium text-gray-400 dark:text-gray-500">
                      {group.label}
                    </div>
              ...
              >
                <span class="flex items-center gap-1">
                  <kbd class="rounded bg-gray-100 px-1 py-0.5 font-mono text-xs dark:bg-gray-700">
                    ↑↓
                  </kbd>
                  <span>导航</span>
                </span>
